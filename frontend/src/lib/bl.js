...
const ICONS = {
  ...
  trash2: 'M3 6h18 M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2 M5 6l1 13a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-13 M10 11v6 M14 11v6',
  ...
  merge:    'M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M6 6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M18 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M6 6v9 M6 9a6 6 0 0 0 6 3h3',
  ...
  /* 数据类型徽标: 字母 A 表示文本类, 带勾方框表示枚举 (11~13px 下笔画不糊) */
  textType:    'M4 20L12 4l8 16 M7.6 14.5h8.8',
  checkSquare: 'M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z M8 12l2.8 2.8L16 9.5',
  /* 表单控件形态: 画控件本身的样子, 而非它对应的动作 */
  fieldInput:    'M2.5 8h19v8h-19z M6 10.5v3',
  fieldTextarea: 'M3 4h18v16H3z M6.5 8.5h11 M6.5 12h11 M6.5 15.5h6',
  fieldSelect:   'M2.5 7h19v10h-19z M14.5 11l2 2 2-2',
  radioDot:      'M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16z M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z',
  stepperUpDown: 'M8 10l4-4 4 4 M8 14l4 4 4-4',
  toggleSwitch:  'M7.5 7h9a5 5 0 0 1 0 10h-9a5 5 0 0 1 0-10z M16 12a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z',
