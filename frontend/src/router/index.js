...
const routes = [
  ...
  { path: '/resources/functions',    name: 'functions',   component: () => import('@/views/resources/Functions.vue'), meta: { title: '函数' } },
  { path: '/resources/functions/:id/ide', name: 'functionIde', component: () => import('@/views/resources/function/ide/FunctionIde.vue'), meta: { title: '在线编排', fullscreen: true } },
