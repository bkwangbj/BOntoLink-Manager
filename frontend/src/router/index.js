...
const routes = [
  ...
  { path: '/resources/value-types',  name: 'valueTypes',  component: () => import('@/views/resources/PlaceholderList.vue'), props: { kind: 'value', title: '值类型', cn: '值类型', en: 'Value types' }, meta: { title: '值类型' } },
